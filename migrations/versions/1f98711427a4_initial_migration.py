...
Revision ID: 1f98711427a4
Revises: 
Create Date: 2024-12-10 13:39:31.713850
...
def upgrade():
    ...
    sa.Column('receiver_type', sa.String(length=10), nullable=False),
    sa.Column('status', sa.String(length=20), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('sender_id', 'sender_type', 'receiver_id', 'receiver_type', name='_unique_connection_request')
    )
